...
<label for="floatingPassword">new password</label>
                    <input type="password"value=" name="password" class="form-control rounded-0" id="floatingPassword" placeholder="Password">
                </div>
 
                <div class="form-group">
                    
                <label for="floatingInput">bio</label>
                    <input type="text"  value="<?=$user['bio']?>" name="bio" class="form-control rounded-0" placeholder="bio">
                </div>
                </div>
